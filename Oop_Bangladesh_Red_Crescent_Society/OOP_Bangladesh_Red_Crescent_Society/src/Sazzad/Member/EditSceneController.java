...
public class EditSceneController implements Initializable {
    ...
    @FXML
    private void saveChangeActionButtonOnClick(ActionEvent event) {
         try{
            Profile profiles = new Profile(Integer.parseInt(phoneNumberTextField.getText()),nameTextField.getText(),emailTextField.getText(),
                    districtTextField.getText(),passwordTextField.getText(),confirmTextField.getText(),bloodGroupComboBox.getValue());
             FileOutputStream fos = new FileOutputStream("profile.bin", true);
             DataOutputStream dos = new DataOutputStream(fos);
             
             dos.writeInt(profiles.getPhoneNumber());
             dos.writeUTF(profiles.getName());
             dos.writeUTF(profiles.getEmail());
             dos.writeUTF(profiles.getDistrict());
             dos.writeUTF(profiles.getPassword());
             dos.writeUTF(profiles.getConfirm());
             dos.writeUTF(profiles.getBloodGroup());
