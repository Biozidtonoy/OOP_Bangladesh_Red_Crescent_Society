...
public class TrainingSceneController implements Initializable {
    ...
    @FXML
    private void submitActionButtonOnClick(ActionEvent event) {
        try{
    ...
    @FXML
    private void payActionButtonOnClick(ActionEvent event) throws IOException {
        Parent mainSceneParent = FXMLLoader.load(getClass().getResource("payScene.fxml"));
        Scene scene1 = new Scene(mainSceneParent);
        Stage window = (Stage)((Node)event.getSource()).getScene().getWindow(); 
        window.setScene(scene1);
        window.show();
    ...
    @FXML
    private void confirmMouseClickOnEvent(ContextMenuEvent event) {
