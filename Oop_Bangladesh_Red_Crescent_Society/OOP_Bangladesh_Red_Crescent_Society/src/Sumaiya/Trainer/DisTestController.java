 ...
 * @author Muntasir
 */
public class DisTestController implements Initializable {
    ...
    private void submitButtonOnClick(ActionEvent event) {
        try {
            ...
            boolean allCorrect = one.equalsIgnoreCase("Planning")
                    && two.equalsIgnoreCase("Water")
                    && third.equalsIgnoreCase("Basement")
                    && four.equalsIgnoreCase("Evacuate")
                    && five.equalsIgnoreCase("Helmet");
