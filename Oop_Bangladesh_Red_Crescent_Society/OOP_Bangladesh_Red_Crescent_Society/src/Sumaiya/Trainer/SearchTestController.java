...
public class SearchTestController implements Initializable {
    ...
    private void submitButtonOnClick(ActionEvent event) {
        try {
            ...
            boolean allCorrect = one.equalsIgnoreCase("Response")
                    && two.equalsIgnoreCase("Prioritization")
                    && third.equalsIgnoreCase("Gear")
                    && four.equalsIgnoreCase("Terrain")
                    && five.equalsIgnoreCase("Training");
