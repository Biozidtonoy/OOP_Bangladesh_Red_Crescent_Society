...
public class TrainerController implements Initializable {
    ...
    @FXML
    private void firstAidTraningButtonOnClick(ActionEvent event) throws IOException {
    ...
    @FXML
    private void resourceButtonOnClick(ActionEvent event) throws IOException {
         Stage currentStage = (Stage) ((Node) event.getSource()).getScene().getWindow();
    ...
    private void fireSafetyButtonOnClick(ActionEvent event) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("fireSafetyTraining.fxml"));
        Parent parent = loader.load();
        Scene newScene = new Scene(parent);
    ...
    private void feedbackButtonOnClick(ActionEvent event) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("feedBackVolunteer.fxml"));
        Parent parent = loader.load();
        Scene newScene = new Scene(parent);
