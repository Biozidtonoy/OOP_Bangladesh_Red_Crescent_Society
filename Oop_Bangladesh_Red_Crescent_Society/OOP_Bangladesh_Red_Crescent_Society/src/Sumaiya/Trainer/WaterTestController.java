 ...
 * @author Muntasir
 */
public class WaterTestController implements Initializable {
    ...
    private void submitButtonOnClick(ActionEvent event) {
         try {
            ...
            boolean allCorrect = one.equalsIgnoreCase("Assessment")
                    && two.equalsIgnoreCase("Analysis")
                    && third.equalsIgnoreCase("Heavy Metals")
                    && four.equalsIgnoreCase("Probe")
                    && five.equalsIgnoreCase("Nutrients");
