...
public class NewsController implements Initializable {
    ...
    @FXML
    private void Datecolumonedit(TableColumn.CellEditEvent<?, ?> event) {
    }

    @FXML
    private void newscolumnonedit(TableColumn.CellEditEvent<?, ?> event) {
    }
